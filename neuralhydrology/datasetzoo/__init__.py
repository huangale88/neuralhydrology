...
from neuralhydrology.datasetzoo.camels_preprocessed_dataset import CamelsDaymetPreprocessed
...
_datasetZooRegistry.register_dataset_class("camels_preprocessed", CamelsDaymetPreprocessed)
